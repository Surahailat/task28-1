<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Loginpage.aspx.cs" Inherits="task28_1.Loginpage" %>
...
<body>
    ...
    data-mdb-ripple-init class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" ID="login" runat = "server" Text="Login" OnClick="login_Click"  />
                                        </div>
